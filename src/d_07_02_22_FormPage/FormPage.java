...
public class FormPage {
	...
	//	driver.findElement(By.xpath("//*[@class='message-element poruka'][@style='visibility: visible']"));
		//return true;
	...
	{JavascriptExecutor js=(JavascriptExecutor) driver;
		WebElement commentField=driver.findElement(By.xpath("//*[@class='form-group'][5]"));
		js.executeAsyncScript("arguments[0].scrollIntoView();", commentField);
